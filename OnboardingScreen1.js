  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <Text style={styles.headline}>Hie... 👋🏽{'\n'}this is your safe place</Text>
        <Text style={styles.subheadline}>Join your local community, discover exciting events, buy and sell with your tribe, and chat with friends.</Text>
